...
import dev.lcehub.emerald.FileManagerFragment;
...
import dev.lcehub.emerald.services.NotificationService;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (editInputControls) {
            ...
            if (containerSettingsId > 0) {
                show(new ContainerDetailFragment(containerSettingsId), false);
            } else {
                ...
                if (containerId > 0 && startPath != null) {
                    show(new FileManagerFragment(startPath), false);
                }
            }
        }
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        } else if (itemId == R.id.main_menu_file_manager) {
