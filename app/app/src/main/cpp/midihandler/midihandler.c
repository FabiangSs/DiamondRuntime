...
Java_dev_lcehub_emerald_winhandler_MIDIHandler_nativeAllocate(JNIEnv *env, jobject obj) {
    MIDIHandler* midiHandler = MIDIHandler_allocate();
    return (jlong)midiHandler;
}

JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_winhandler_MIDIHandler_destroy(JNIEnv *env, jobject obj,
                                                 jlong nativePtr) {
    MIDIHandler_destroy((MIDIHandler*)nativePtr);
}

JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_winhandler_MIDIHandler_noteOn(JNIEnv *env, jobject obj, jlong nativePtr,
                                                jint channel, jint note, jint velocity) {
    MIDIHandler_noteOn((MIDIHandler*)nativePtr, channel, note, velocity);
}

JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_winhandler_MIDIHandler_noteOff(JNIEnv *env, jobject obj, jlong nativePtr,
                                                 jint channel, jint note) {
    MIDIHandler_noteOff((MIDIHandler*)nativePtr, channel, note);
}

JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_winhandler_MIDIHandler_loadSoundFont(JNIEnv *env, jobject obj, jlong nativePtr,
...
JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_winhandler_MIDIHandler_programChange(JNIEnv *env, jobject obj, jlong nativePtr,
                                                       jint channel, jint program) {
    MIDIHandler_programChange((MIDIHandler*)nativePtr, channel, program);
}

JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_winhandler_MIDIHandler_controlChange(JNIEnv *env, jobject obj, jlong nativePtr,
                                                       jint channel, jint control, jint value) {
    MIDIHandler_controlChange((MIDIHandler*)nativePtr, channel, control, value);
}

JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_winhandler_MIDIHandler_pitchBend(JNIEnv *env, jobject obj, jlong nativePtr,
                                                   jint channel, jint value) {
    MIDIHandler_pitchBend((MIDIHandler*)nativePtr, channel, value);
}

JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_winhandler_MIDIHandler_keyPressure(JNIEnv *env, jobject obj, jlong nativePtr,
