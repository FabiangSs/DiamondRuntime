...
Java_dev_lcehub_emerald_core_GPUHelper_vkGetDeviceExtensions(JNIEnv *env, jclass obj) {
...
Java_dev_lcehub_emerald_core_GPUHelper_vkGetApiVersion() {
    int version = 0;
...
Java_dev_lcehub_emerald_core_GPUHelper_setGlobalEGLContext(JNIEnv *env, jclass obj) {
