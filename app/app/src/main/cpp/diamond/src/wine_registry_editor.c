...
Java_dev_lcehub_emerald_core_WineRegistryEditor_getKeyLocation(JNIEnv *env, jobject obj,
...
JNIEXPORT jintArray JNICALL
Java_dev_lcehub_emerald_core_WineRegistryEditor_getValueLocation(JNIEnv *env, jobject obj,
