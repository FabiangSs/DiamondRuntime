...
static char *get_native_library_dir(JNIEnv *env, jobject context) {
    ...
    if (context != NULL) {
        jclass class_ = (*env)->FindClass(env,"dev/lcehub/emerald/core/AppUtils");
...
static char *get_library_name(JNIEnv *env, jobject context, const char *driver_name) {
    ...
    jclass adrenotoolsManager = (*env)->FindClass(env, "dev/lcehub/emerald/contents/AdrenotoolsManager");
...
Java_dev_lcehub_emerald_core_GPUInformation_getVulkanVersion(JNIEnv *env, jclass obj, jstring driverName, jobject context) {
...
Java_dev_lcehub_emerald_core_GPUInformation_getVendorID(JNIEnv *env, jclass obj, jstring driverName, jobject context) {
    VkPhysicalDeviceProperties props = {};
    uint32_t vendorID;
...
JNIEXPORT jstring JNICALL
Java_dev_lcehub_emerald_core_GPUInformation_getRenderer(JNIEnv *env, jclass obj, jstring driverName, jobject context) {
    VkPhysicalDeviceProperties props = {};
    char *renderer;
...
Java_dev_lcehub_emerald_core_GPUInformation_enumerateExtensions(JNIEnv *env, jclass obj, jstring driverName, jobject context) {
