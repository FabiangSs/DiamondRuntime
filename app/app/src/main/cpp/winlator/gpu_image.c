...
Java_dev_lcehub_emerald_renderer_GPUImage_hardwareBufferFromSocket(JNIEnv *env, jclass obj, jint fd) {
    AHardwareBuffer *ahb;
    uint8_t buf = 1;
    if (write(fd, &buf, 1) == -1) {
...
JNIEXPORT jlong JNICALL
Java_dev_lcehub_emerald_renderer_GPUImage_createHardwareBuffer(JNIEnv *env, jclass obj, jshort width, jshort height) {
...
Java_dev_lcehub_emerald_renderer_GPUImage_destroyHardwareBuffer(JNIEnv *env, jclass obj, jlong ptr) {
...
Java_dev_lcehub_emerald_renderer_GPUImage_unlockHardwareBuffer(JNIEnv *env, jclass obj, jlong ptr) {
    AHardwareBuffer *ahb = (AHardwareBuffer *)ptr;
    if (!ahb) return -1;
    int fence_fd = -1;
...
Java_dev_lcehub_emerald_renderer_GPUImage_lockHardwareBuffer(JNIEnv *env, jobject obj, jlong ptr) {
    AHardwareBuffer *ahb = (AHardwareBuffer *)ptr;
    if (!ahb) {
