...
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeInit(
...
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeResize(JNIEnv*, jobject, jlong h, jint w, jint ht) {
    auto* r=reinterpret_cast<VulkanRendererContext*>(h); if (r) r->onSurfaceResized(w,ht);
}
extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeDestroy(JNIEnv*, jobject, jlong h) {
    delete reinterpret_cast<VulkanRendererContext*>(h);
}
extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeUpdateWindowContent(
...
extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeUpdateWindowContentAHB(
...
extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeSetTransformAndScissor(
...
extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeSetPointerPos(JNIEnv*, jobject, jlong handle, jshort x, jshort y) {
    auto* r=reinterpret_cast<VulkanRendererContext*>(handle); if (r) r->updatePointerPosition(x,y);
}
extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeSetCursorVisible(JNIEnv*, jobject, jlong handle, jboolean v) {
    auto* r=reinterpret_cast<VulkanRendererContext*>(handle); if (r) r->setCursorVisible(v);
}
extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeUpdateCursorImage(
...
extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeSetRenderList(
...
extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeRemoveWindow(JNIEnv*, jobject, jlong handle, jlong id) {
    auto* r=reinterpret_cast<VulkanRendererContext*>(handle); if (r) r->removeWindow(id);
}


extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeSetVerboseLog(JNIEnv*, jobject, jlong handle, jboolean v) {
    auto* r = reinterpret_cast<VulkanRendererContext*>(handle);
    if (r) r->setVerboseLog((bool)v);
}

extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeDumpRendererInfo(JNIEnv*, jobject, jlong handle) {
    auto* r = reinterpret_cast<VulkanRendererContext*>(handle);
...
extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeSetFilterMode(JNIEnv*, jobject, jlong handle, jint mode) {
    auto* r = reinterpret_cast<VulkanRendererContext*>(handle);
    if (r) r->setFilterMode((int)mode);
}

extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeSetStretchMode(JNIEnv*, jobject, jlong handle, jint mode) {
    auto* r = reinterpret_cast<VulkanRendererContext*>(handle);
    if (r) r->setStretchMode((int)mode);
}

extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeSetPostFXMode(JNIEnv*, jobject, jlong handle, jint mode) {
    auto* r = reinterpret_cast<VulkanRendererContext*>(handle);
    if (r) r->setPostFXMode((int)mode);
}

extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeSetSharpness(JNIEnv*, jobject, jlong handle, jfloat s) {
    auto* r = reinterpret_cast<VulkanRendererContext*>(handle);
    if (r) r->setSharpness((float)s);
}

extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeSetSwapRB(JNIEnv*, jobject, jlong handle, jboolean enabled) {
    auto* r = reinterpret_cast<VulkanRendererContext*>(handle);
    if (r) r->setSwapRB(enabled == JNI_TRUE);
}

extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeSetPresentMode(JNIEnv*, jobject, jlong handle, jint mode) {
    auto* r = reinterpret_cast<VulkanRendererContext*>(handle);
    if (r) r->setPresentMode((VkPresentModeKHR)mode);
}

extern "C" JNIEXPORT jintArray JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeGetSupportedPresentModes(JNIEnv* env, jobject, jlong handle) {
    auto* r = reinterpret_cast<VulkanRendererContext*>(handle);
...
extern "C" JNIEXPORT jintArray JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeGetSwapchainSize(JNIEnv* env, jobject, jlong handle) {
...
extern "C" JNIEXPORT void JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeDetachSurface(JNIEnv*, jobject, jlong handle) {
    auto* r = reinterpret_cast<VulkanRendererContext*>(handle);
    if (r) r->detachSurface();
}

extern "C" JNIEXPORT jboolean JNICALL
Java_dev_lcehub_emerald_renderer_VulkanRenderer_nativeReattachSurface(JNIEnv* env, jobject, jlong handle, jobject surface) {
    auto* r = reinterpret_cast<VulkanRendererContext*>(handle);
